...
window.SITE = {
  ...
  site: {
    ...
    instagram: "",
    sisters: [
      { label: "By city", href: "cities.html" },
      { label: "Machines", href: "machines.html" },
    ],
  },

  hero: {
    title: "Five assets.<br class='only-mobile'> One auction.",
    sub: "A Porsche 911, a HondaJet and three machines. 34 surfaces, twelve months, one brand per industry.",
    unit: "asset",
  },
  ...
  markets: [
    {
      /* FOTO OFICIAL de catálogo — grupoconstrumarket.com (empresa de Jose) */
      page: "s570.html", id: "s570", city: "Bobcat S570", country: "Skid steer · 68 hp", flag: "🚜", status: "live",
      ...
      zones: [
        ...
        { id: "side",    name: "Side Panel",   x: 62, y: 54 },
        { id: "arm",     name: "Lift Arm",     x: 68, y: 39 },
        { id: "cabroof", name: "Cab Roof",     x: 53, y: 21 },
        { id: "bucket",  name: "Bucket",       x: 27, y: 62 },
      ...
      spots: [
        ...
        { id: "bucket",  price:  7000, status: "open" },
        { id: "rims",    price:  6000, status: "open" },
      ],
    },
    {
    ...
    {
      /* FOTO OFICIAL Komatsu de marketing — grupoconstrumarket.com */
      page: "pc200.html", id: "pc200", city: "Komatsu PC200", country: "Excavator · 20 t", flag: "⚙️", status: "live",
    ...
    {
      /* FOTO REAL — HondaJet HA-420 Elite S · CC BY-SA 4.0 (crédito en footer) */
      page: "hondajet.html", id: "jet", city: "HondaJet", country: "HA-420 Elite", flag: "✈️", status: "live",
      ...
      zones: [
        ...
        { id: "aft",      name: "Aft Fuselage",     x: 57, y: 58 },
        { id: "mid",      name: "Mid Fuselage",     x: 48, y: 53 },
        { id: "fwd",      name: "Forward Fuselage", x: 27, y: 57 },
        { id: "door",     name: "Entry Door",       x: 38, y: 56 },
        { id: "winglet",  name: "Winglet",          x: 88, y: 58 },
    ...
    {
      /* FOTO REAL — Porsche 911 (992) Carrera GTS · CC BY-SA 4.0 (crédito en footer) */
      page: "911.html", id: "p911", city: "Porsche 911", country: "992 Carrera GTS", flag: "🏁", status: "live",
      ...
      zones: [
        ...
        { id: "door",     name: "Door Panel",     x: 38, y: 48 },
        { id: "rquarter", name: "Rear Quarter",   x: 17, y: 42 },
        { id: "skirt",    name: "Side Skirt",     x: 35, y: 70 },
        { id: "splitter", name: "Front Splitter", x: 82, y: 77 },
        { id: "ducktail", name: "Rear Wing",      x: 10, y: 25 },
